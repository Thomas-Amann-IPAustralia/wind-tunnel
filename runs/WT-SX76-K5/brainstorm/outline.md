...
updated_at: "2026-07-30T00:16:44Z"
...
The system must be platform-agnostic, operate within a sovereign, air-gapped environment, and adhere to Australian Whole-of-Government (WofG) standards. The LLM endpoint must be hosted on sovereign or self-managed infrastructure to ensure data sovereignty and security, with specific model provenance and residency requirements deferred to future implementation phases.
