...
def generate_poc(client: LLMClient, *, outline_md: str) -> PocResult:
    ...
    user = "\n\n".join(
        [
            wrap_untrusted(outline_md, label="## The project outline to prototype"),
    ...
    resp = client.complete_text(prompt.model_role, prompt.system, user)
